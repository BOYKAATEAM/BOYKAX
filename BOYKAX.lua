...
while(true) do
rm -fr ../.telegram-cli
screen -S BOYKAX -X kill
screen -S BOYKAX ./BOYKAX
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BOYKAXTEAM/Files_BOYKAX/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBOYKAXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(400866650) then  
var = true  
...
if tonumber(user_id) == tonumber(1758544971) then  
var = 'مبرمج السورس'
...
local UserName = (data.username_ or "VVVIILIU")
...
BOYKAX_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BOYKAX_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BOYKAX_Msg = 'امبروطور التفاعل' 
...
if not DevBOYKAXW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBOYKAXW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ❃' and DevBOYKAXW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevBOYKAXW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevBOYKAXW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevBOYKAXW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevBOYKAXW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevBOYKAXW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevBOYKAXW(msg) then 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/BOBBW) \n ❃∫ [قناه السورس](t.me/VVVIILIU)')
end
if text == "ضع اسم للبوت ❃" and DevBOYKAXW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevBOYKAXW(msg) then 
...
if text == 'المشتركين ❃' and DevBOYKAXW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevBOYKAXW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevBOYKAXW(msg) then
...
if text == ("قائمه العام ❃") and DevBOYKAXW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevBOYKAXW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevBOYKAXW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevBOYKAXW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevBOYKAXW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevBOYKAXW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevBOYKAXW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevBOYKAXW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevBOYKAXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevBOYKAXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..BOYKAXk..''..BOYKAX..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBOYKAXW(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'VVVIILIU')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevBOYKAXW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VVVIILIU')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBOYKAXW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBOYKAXW(msg) then
...
if BOYKAX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'VVVIILIU')..') \n ❃∫ '..BOYKAX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/VVVIILIU)}\n ❃∫ ["..BOYKAX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/VVVIILIU)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBOYKAXW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBOYKAXW(msg) then
...
if text and text:match("^تغير رساله الاشتراك$") and DevBOYKAXW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevBOYKAXW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevBOYKAXW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevBOYKAXW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevBOYKAXW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevBOYKAXW(msg) then  
...
database:sadd(bot_id.."BOYKAX:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."BOYKAX:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_BOYKAX = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BOYKAX then 
names_BOYKAX = database:smembers(bot_id.."BOYKAX:blocname"..msg.chat_id_) or ""
if names_BOYKAX and names_BOYKAX[1] then 
for i=1,#names_BOYKAX do 
if name_BOYKAX:match("(.*)("..names_BOYKAX[i]..")(.*)") then 
...
database:set(bot_id.."BOYKAX:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BOYKAX:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BOYKAX:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BOYKAX:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BOYKAX:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BOYKAXa_new(BOYKAX1,BOYKAX2)
if BOYKAX2 and BOYKAX2.first_name_ then 
if BOYKAX2.first_name_:match("(.*)"..database:get(bot_id.."BOYKAX:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BOYKAX:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BOYKAX_nnn = database:get(bot_id.."BOYKAX:nump"..msg.chat_id_) or 5
local BOYKAX_nnn2 = database:get(bot_id.."BOYKAX:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BOYKAX_nnn2) == tonumber(BOYKAX_nnn) or tonumber(BOYKAX_nnn2) > tonumber(BOYKAX_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BOYKAX:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..BOYKAX2.username_.."](https://t.me/"..(BOYKAX2.username_ or "VVVIILIU")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BOYKAX:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(BOYKAX_nnn) - tonumber(BOYKAX_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BOYKAXa_new)
end
end
...
local BOYKAXChengName = database:get(bot_id.."BOYKAX:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BOYKAXChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BOYKAXChengName..']')
database:del(bot_id.."BOYKAX:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BOYKAXChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BOYKAX:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BOYKAXChengUserName = database:get(bot_id.."BOYKAX:Cheng:UserName"..data.id_)
if not data.username_ then 
if BOYKAXChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BOYKAXChengUserName..']')
database:del(bot_id.."BOYKAX:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BOYKAXChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BOYKAX:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BOYKAXChengPhoto = database:get(bot_id.."BOYKAX:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BOYKAXChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BOYKAX:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BOYKAXChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BOYKAX:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
≪━━━━━━KS━━━━━━≫
 ❃∫ ↬𝐁𝐎𝐘𝐊𝐀 𝐓𝐄𝐀𝐌
≪━━━━━━KS━━━━━━≫
 ❃∫ ↬[Channel BOYKAX](t.me/VVVIILIU) 
≪━━━━━━KS━━━━━━≫
 ❃∫ ↬[Information](t.me/BOBBW)
≪━━━━━━KS━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/CCFRR)
≪━━━━━━KS━━━━━━≫
 ❃∫ ↬[orders BOYKAX](t.me/source_BOYKAX)
≪━━━━━━KS━━━━━━≫
...
if text == 'رفع نسخه الاحتياطيه' and DevBOYKAXW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'VVVIILIU')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VVVIILIU')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBOYKAXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBOYKAXW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBOYKAXW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBOYKAXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBOYKAXW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBOYKAXW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBOYKAXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBOYKAXW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBOYKAXW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBOYKAXW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBOYKAXW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBOYKAXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "VVVIILIU")
...
function Function_BOYKAX(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BOYKAX, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BOYKAX, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VVVIILIU')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VVVIILIU')..')'
...
if text == 'مسح كليشه المطور' and DevBOYKAXW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBOYKAXW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'VVVIILIU')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevBOYKAXW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBOYKAXW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevBOYKAXW(msg) then 
...
if text == ("مسح ردود المطور") and DevBOYKAXW(msg) then 
...
if text == ("ردود المطور") and DevBOYKAXW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━KS━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBOYKAXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBOYKAXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevBOYKAXW(msg) then   
...
if text == 'تعطيل المغادره' and DevBOYKAXW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOYKAX')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'VVVIILIU')..')'
local iduser = result.sender_user_id_
...
if text == 'استعاده الاوامر' and DevBOYKAXW(msg) then
...
zh = https.request('https://rudi-dev.tk/Amir1/BOYKAX.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━KS━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━KS━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/VVVIILIU)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/BOYKAX.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/BOYKAX.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"وين تحب تسافر","فنانك المفضل","اسمك الحقيقي نفسه اسمك بالتلي؟؟","تحب منوو","تتوقع روحك بالجنه لو بالنار","اكثر دكه ناقصه شسويتها","تعرف شكد احبك","عيونك يالون","اسم التحبه/تحبي؟؟","هم تكره الشجر","تعرف حسون ؟؟"," سويت اخر شي؟؟","تدري انته كيك","‏ما هي الصفة التي تبتعد عن الآخرين بسببها . . . ؟.","فكرة خاطئة منتشرة عند البنات ؟.","هل مدمن ع شي متكدر تتركه"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
send(msg.chat_id_,0,''..t..'\n≪━━━━━━KS━━━━━━≫\n ❃∫ تم التعديل على الميديا\n ❃∫ الشخص الي قام بالتعديل\n ❃∫ ايدي الشخص ◂ '..result.ender_user_id_..'\n ❃∫ معرف الشخص»{ '..users..' }') 
end,nil)
